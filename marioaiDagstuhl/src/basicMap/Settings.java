...
public class Settings {
	...
	public static final String WASSERSTEIN_PATH = "src/pytorch" + File.separator + "generator_ws.py";
	public static final String WASSERSTEIN_GAN = "src/pytorch" + File.separator + "netG_epoch_5000.pth";
